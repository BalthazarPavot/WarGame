...
public class MainScreen extends GameScreen {
   ...
   */
  public void prepare () {
    String[] buttonTexts = {QUICK_GAME_STRING, NEW_GAME_STRING, LOAD_GAME_STRING,
    		CONFIGURATION_STRING, QUIT_GAME_STRING} ;
    int w ;
    int h ;
    ...
    for (int i=7, j=0 ; i < 12 ; j++, i ++ ) {
      ...
      button = new ButtonWidget (buttonTexts[j],
        w/2-100, h/15*i, 200, 30, 20, new Color (128, 128, 128)) ;
